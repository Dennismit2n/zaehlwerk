...
var I18N = {
  ...
  de: {
    ...
    tickerTitel: 'Lieber live nebenher statt Rückschau?',
    tickerText: 'Der <strong>Zählwerk Ticker</strong> ist eine kleine schwebende Anzeige für Windows: laufendes Fünf-Stunden-Fenster, Tagessumme, Modelle. Liest dieselben Dateien, ebenfalls ohne Netzzugriff.',
    tickerDownload: 'Für Windows herunterladen',
    tickerQuellcode: 'Quellcode',
  ...
  en: {
    ...
    tickerTitel: 'Prefer it live alongside, instead of in hindsight?',
    tickerText: '<strong>Zählwerk Ticker</strong> is a small floating readout for Windows: current five-hour window, daily total, models. Reads the same files, likewise without network access.',
    tickerDownload: 'Download for Windows',
    tickerQuellcode: 'Source code',
  ...
  es: {
    ...
    tickerTitel: '¿Prefieres verlo en directo en vez de en retrospectiva?',
    tickerText: '<strong>Zählwerk Ticker</strong> es un pequeño indicador flotante para Windows: ventana de cinco horas en curso, total del día, modelos. Lee los mismos archivos, también sin acceso a la red.',
    tickerDownload: 'Descargar para Windows',
    tickerQuellcode: 'Código fuente',
  ...
  fr: {
    ...
    tickerTitel: 'Plutôt en direct que rétrospectivement ?',
    tickerText: '<strong>Zählwerk Ticker</strong> est un petit affichage flottant pour Windows : fenêtre de cinq heures en cours, total du jour, modèles. Il lit les mêmes fichiers, sans accès réseau lui non plus.',
    tickerDownload: 'Télécharger pour Windows',
    tickerQuellcode: 'Code source',
  ...
  pt: {
    ...
    tickerTitel: 'Prefere ver em direto em vez de em retrospetiva?',
    tickerText: 'O <strong>Zählwerk Ticker</strong> é um pequeno mostrador flutuante para Windows: janela de cinco horas em curso, total do dia, modelos. Lê os mesmos ficheiros, também sem acesso à rede.',
    tickerDownload: 'Transferir para Windows',
    tickerQuellcode: 'Código-fonte',
  ...
  tr: {
    ...
    tickerTitel: 'Geriye bakmak yerine anlık izlemek mi?',
    tickerText: '<strong>Zählwerk Ticker</strong>, Windows için küçük bir yüzen gösterge: yürüyen beş saatlik pencere, günlük toplam, modeller. Aynı dosyaları okur, o da ağ erişimi olmadan.',
    tickerDownload: 'Windows için indir',
    tickerQuellcode: 'Kaynak kodu',
  ...
  ru: {
    ...
    tickerTitel: 'Хотите видеть это вживую, а не задним числом?',
    tickerText: '<strong>Zählwerk Ticker</strong> — небольшое плавающее окошко для Windows: текущее пятичасовое окно, итог за день, модели. Читает те же файлы и тоже без доступа к сети.',
    tickerDownload: 'Скачать для Windows',
    tickerQuellcode: 'Исходный код',
  ...
  hi: {
    ...
    tickerTitel: 'पीछे देखने के बजाय साथ-साथ देखना है?',
    tickerText: '<strong>Zählwerk Ticker</strong> Windows के लिए एक छोटा तैरता हुआ पैनल है: चालू पाँच-घंटे की खिड़की, दिन का जोड़, मॉडल। यह वही फ़ाइलें पढ़ता है, और वह भी बिना नेटवर्क पहुँच के।',
    tickerDownload: 'Windows के लिए डाउनलोड करें',
    tickerQuellcode: 'स्रोत कोड',
  ...
  zh: {
    ...
    tickerTitel: '想边干边看，而不是事后回顾？',
    tickerText: '<strong>Zählwerk Ticker</strong> 是 Windows 上的一个小浮窗：当前五小时窗口、当日合计、模型分布。读取同样的文件，同样不联网。',
    tickerDownload: '下载 Windows 版',
    tickerQuellcode: '源代码',
  ...
  ja: {
    ...
    tickerTitel: 'あとから振り返るより、作業中に見たい方へ',
    tickerText: '<strong>Zählwerk Ticker</strong> は Windows 用の小さな浮動表示です。進行中の五時間枠、その日の合計、モデル別の内訳。同じファイルを読み、こちらもネットワークにはつながりません。',
    tickerDownload: 'Windows 版をダウンロード',
    tickerQuellcode: 'ソースコード',
  ...
  ko: {
    ...
    tickerTitel: '돌아보기보다 작업 중에 보고 싶다면',
    tickerText: '<strong>Zählwerk Ticker</strong>는 Windows용 작은 떠 있는 표시창입니다. 진행 중인 다섯 시간 창, 하루 합계, 모델별 내역. 같은 파일을 읽으며, 이쪽도 네트워크에 연결되지 않습니다.',
    tickerDownload: 'Windows용 내려받기',
    tickerQuellcode: '소스 코드',
